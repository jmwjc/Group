...
#### 调整导出和插件格式
- 编辑 -> 设置 -> 导出 -> 条目格式 -> 选择 [Better BibTex](https://retorque.re/zotero-better-bibtex/)
- 点击[Better BibTex](https://retorque.re/zotero-better-bibtex/) -> 更改引用格式公式(auth.lower + year)
#### 文献导出
- 文件 -> 导出文献库 -> 格式选择[Better BibTex](https://retorque.re/zotero-better-bibtex/) -> 点击保持更新
